...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendWelcomeEmail(Socio socio) {
        ...
        String text = String.format(
            ...
            "- DNI: %s\n" +
            "- Membresía: %s\n\n" +
            "Ahora puedes acceder a nuestra plataforma con tu email y contraseña para:\n" +
            "- Reservar clases\n" +
    ...
    public void sendReservaConfirmacionEmail(Socio socio, String nombreClase, String fecha, String hora) {
        String subject = "Confirmación de Reserva - Inca Fit";
        String text = String.format(
            "Hola %s,\n\n" +
            ...
            "Si necesitas cancelar tu reserva, por favor hazlo con al menos 2 horas de anticipación.\n\n" +
            "Saludos cordiales,\n" +
            "El equipo de Inca Fit",
            socio.getNombre(),
            nombreClase,
    ...
    public void sendWelcomeEmailHtml(Socio socio) {
        try {
            ...
            sendHtmlEmail(socio.getEmail(), "¡Bienvenido a Inca Fit!", htmlContent);
            System.out.println("✅ Email HTML de bienvenida enviado a: " + socio.getEmail());
        } catch (Exception e) {
            System.err.println("⚠️ Error al enviar email HTML de bienvenida: " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    public void sendReservaConfirmacionEmailHtml(Socio socio, String nombreClase, String fecha, String hora) {
        try {
            ...
            sendHtmlEmail(socio.getEmail(), "Confirmación de Reserva - Inca Fit", htmlContent);
            System.out.println("✅ Email HTML de confirmación de reserva enviado a: " + socio.getEmail());
        } catch (Exception e) {
            System.err.println("⚠️ Error al enviar email HTML de confirmación: " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    public void sendRecordatorioMembresiaEmail(Socio socio, int diasRestantes) {
        String subject = "Recordatorio: Tu Membresía Vence Pronto - Inca Fit";
        String text = String.format(
            "Hola %s,\n\n" +
            "Te recordamos que tu membresía '%s' vencerá en %d días.\n\n" +
            "Fecha de vencimiento: %s\n\n" +
            "Para evitar interrupciones en tu entrenamiento, te recomendamos renovar tu membresía " +
            "antes de la fecha de vencimiento.\n\n" +
            "Puedes renovar fácilmente desde tu panel de usuario o contactándonos directamente.\n\n" +
    ...
    // Método auxiliar para enviar emails HTML
    private void sendHtmlEmail(String to, String subject, String htmlContent) {
        try {
            ...
            mailSender.send(message);
            System.out.println("✅ Email HTML enviado correctamente a: " + to);
        } catch (MessagingException e) {
            System.err.println("❌ Error al enviar email HTML a " + to + ": " + e.getMessage());
            e.printStackTrace();
